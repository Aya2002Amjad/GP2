...
import 'package:zfffft/Componant/BackButton.dart';
import 'package:zfffft/Componant/MultiLineTextFormField.dart';
import 'package:zfffft/Componant/MyTextFormField.dart';
                      ...
                      InkWell(
                        ...
                        child: Obx(() => Container(
                          ...
                          child: Center(
                            ...
                            : Image.network(fileController.imageUrl.value,
                            fit: BoxFit.cover,
                            ),
                      ...
                      Expanded(
                        child: Obx(() => Container(
                          ...
                          decoration: BoxDecoration(
                              color: AppConstant.appMainColor,
                              borderRadius: BorderRadius.circular(15)),
                          child: fileController.isPostUploading.value ? Center(
                            child: CircularProgressIndicator(),
                          ) :InkWell(
                            onTap: (){
