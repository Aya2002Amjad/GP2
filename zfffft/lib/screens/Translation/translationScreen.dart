...
void translateText() async {
  ...
  if (translatedText.trim().isEmpty) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Nothing to copy!', style: TextStyle(color: Colors.white),),
  ...
  ScaffoldMessenger.of(context).showSnackBar(
    SnackBar(
      content: Text('the translation has been copied ',style: TextStyle(color: Colors.white)),
            ...
            TextField(
              ...
              onChanged: (text) {
                setState(() {
                  ...
                  translatedText = ''; // Clear translation result when input is empty
                       }
                });
              },
            ),
