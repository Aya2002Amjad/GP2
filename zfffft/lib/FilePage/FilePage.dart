...
void _clearAnnotationAndSelection() {
  ...
  final annotations = List<Annotation>.from(_pdfViewerController.getAnnotations());
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: const Icon(Icons.edit,color: AppConstant.appTextColor,),
            onPressed: () {
              setState(() {
          ...
          children: [
            IconButton(
              icon: Icon(Icons.highlight,
                  color: _currentMode == PdfAnnotationMode.highlight ? Colors.orange : null),
              tooltip: 'Highlight',
            ...
            IconButton(
              icon: Icon(Icons.format_underline,
                  color: _currentMode == PdfAnnotationMode.underline ? Colors.orange : null),
              tooltip: 'Underline',
            ...
            IconButton(
              icon: Icon(Icons.strikethrough_s,
                  color: _currentMode == PdfAnnotationMode.strikethrough ? Colors.orange : null),
              tooltip: 'Strikethrough',
              onPressed: () => _setAnnotationMode(PdfAnnotationMode.strikethrough),
            ),
             SizedBox(height: 10,),
            IconButton(
              icon: Icon(Icons.format_overline,
                  color: _currentMode == PdfAnnotationMode.squiggly ? Colors.orange : null),
              tooltip: 'Squiggly',
            ...
            IconButton(
              icon: Icon(Icons.sticky_note_2_outlined,
                  color: _currentMode == PdfAnnotationMode.stickyNote ? Colors.orange : null),
              tooltip: 'Sticky Note',
