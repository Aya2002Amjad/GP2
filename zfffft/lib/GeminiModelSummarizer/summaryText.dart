...
Future<bool> requestStoragePermission() async {
 ...
 Future<void> _generateAndSavePDF(BuildContext context) async {
  ...
  try {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text("PDF Downloaded!"),backgroundColor:AppConstant.appMainColor),
    );
    OpenFile.open(path); 
  } catch (e) {
            ...
            children: [
              ...
              if (!isHistory) ...[
                ...
                ElevatedButton(
                  ...
                  child: Text('Save Summary',style: TextStyle(color: AppConstant.appMainColor)),
                ),
                const SizedBox(height: 10),
                ElevatedButton(
                  onPressed: () => _generateAndSavePDF(context),
                  child: Text("Download as PDF",style: TextStyle(color: AppConstant.appMainColor)),
                ),
              ]
            ],
          ),
