...
class _ChatbotscreenState extends State<Chatbotscreen> {
  ...
  Widget _buildMessageText(ChatMessage message, ChatMessage? previousMessage, ChatMessage? nextMessage) {
  ...
  void _editMessage(ChatMessage oldMessage) {
    TextEditingController _controller = TextEditingController(text: oldMessage.text);
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            TextButton(
              child: Text("Cancel", style: TextStyle(color: AppConstant.appMainColor)),
    ...
    final ImageSource? source = await showDialog<ImageSource>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(
            'Choose Image Source?',
            style: TextStyle(color: AppConstant.appMainColor, fontSize: 18, fontWeight: FontWeight.bold),
          ),
          content: Column(
