...
import 'package:zfffft/Screens/ToDoList/edit_screen.dart';
import 'package:zfffft/Screens/ToDoList/firestorTodo.dart';
import 'package:zfffft/screens/ToDoList/TaskDetailScreen';
                        ...
                        children: [
                          ...
                          Checkbox(
                            ...
                            onChanged: (value) {
                              ...
                              FireStore_Datasource().isdone(widget._task.id, isDone);
                            },
                          ),
                        ],
                      ),
                          ...
                          children: [
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    Icon(Icons.watch_later_outlined, color: AppConstant.appTextColor),
                                    SizedBox(width: 2),
                                    Text(
                                      widget._task.time,
                                      style: TextStyle(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      SizedBox(width: 10),
                                      Icon(Icons.edit, color: AppConstant.appTextColor),
                                      SizedBox(width: 2),
                                    ],
                                  ),
                                ),
                            ...
                            GestureDetector(
                              onTap: () async {
                                await FireStore_Datasource().delete_task(widget._task.id);
                              },
                              child: Container(
                                width: 60,
                                height: 30,
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      SizedBox(width: 10),
                                      Icon(Icons.delete, color: AppConstant.appTextColor),
                                      SizedBox(width: 2),
                                    ],
                                  ),
                                ),
